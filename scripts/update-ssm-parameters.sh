...
declare -A SSM_PARAMS=(
    ...
    ["/repostly/api/STRIPE_SORA_10_PRICE_ID"]="Stripe Sora API $10 credit price ID"
    ["/repostly/api/STRIPE_SORA_20_PRICE_ID"]="Stripe Sora API $20 credit price ID"
    ["/repostly/api/STRIPE_SORA_50_PRICE_ID"]="Stripe Sora API $50 credit price ID"
    ["/repostly/api/STRIPE_SORA_100_PRICE_ID"]="Stripe Sora API $100 credit price ID"
    ["/repostly/api/CREDITS_PER_USD"]="Sora API credits per dollar (pricing ratio)"
    ...
    ["/repostly/api/TIKTOK_CLIENT_KEY"]="TikTok OAuth client key"
    ["/repostly/api/TIKTOK_CLIENT_SECRET"]="TikTok OAuth client secret"
