...
const isProdHost = typeof window !== "undefined" && 
  (window.location.hostname === "realdoc.com" || 
   ...
   window.location.hostname === "app.reelpostly.com" ||
   window.location.hostname === "reelpostly.com");

const clerkConfig = {
  publishableKey: resolveClerkKey(),
  fallbackRedirectUrl: joinUrl(PUBLIC_BASE, "documentation-generator"),
  afterSignInUrl: joinUrl(PUBLIC_BASE, "documentation-generator"),
  afterSignUpUrl: joinUrl(PUBLIC_BASE, "documentation-generator"),
