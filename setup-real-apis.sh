...
echo "🚀 CreatorSync - Real API Setup Script"
echo "======================================"
echo ""
...
show_setup_instructions() {
    ...
    echo ""
    print_info "📋 $platform_name Setup Instructions:"
    echo "======================================"
    ...
    case $platform in
        "instagram")
            ...
            echo "4. Go to Settings → Basic to get App ID"
            echo "5. Go to Tools → Graph API Explorer"
